...
def get_parser():
    ...
    parser.add_argument('--virtual-residues', default=False, action='store_true', help='Display the virtual residues as spheres')
    parser.add_argument('--only-elements', dest='only_elements', default=None,
                     help='Display only these elements, separated by commas')
    parser.add_argument('--no-loops', action="store_true", help="Don't display the coarse-grain hairpin loops")
    parser.add_argument('--longrange', default=False, action='store_true', help="Display long-range interactions")
