...
def get_parser():
    ...
    parser.add_argument('--plot', action="store_true",  help="Open a window with a plot of the projections")
    return parser
...
def main(parser):
    ...
    with fuc.hide_traceback():
        cg1, cg2 = fuc.cgs_from_args(args, nargs = 2, rna_type="3d", enable_logging=True)
