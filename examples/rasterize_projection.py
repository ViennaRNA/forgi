...
def get_parser():
    ...
    parser.add_argument('-w', '--width', type=int,
                        help='Width in Angstrom', default=300)
    parser.add_argument('-d', '--dpi', type=int,
                        help='Number of pixels in the image', default=50)
    parser.add_argument('-r', '--rotate', type=int,
                        help='Degrees to rotate in plane', default=99999999999)
    parser.add_argument(
        '-n', type=int, help='Number of images to produce.', default=1)
    parser.add_argument('--res-nums', type=str,
                        help='A "," separated list of nucleotide positions.')
    return parser
