...
schlickAnnotations = [
    ("1NKW.cg", [[(24, 526), (31, 485)], [(32, 484), (35, 457)], [(55, 112), (56, 69)], [(128, 119), (129, 142)],
                 [(156, 45), (161, 189)], [(348, 336),
                                           (352, 308)], [(696, 807), (702, 786)],
                 [(745, 713), (749, 773)], [(848, 835), (849, 954)], [
        (1111, 1102), (1115, 1066)],
        [(1174, 1002), (1178, 1196)], [(1319, 1638),
                                       (1322, 1621)], [(1415, 1398), (1420, 1611)],
        [(1656, 1643), (1659, 1311)], [(1971, 1755),
                                       (1977, 1683)], [(2057, 2414), (2060, 2222)],
        [(2179, 2076), (2183, 2202)], [(2349, 2326),
                                       (2351, 2360)], [(2425, 2407), (2434, 2475)],
    ...
    ("1NBS.cg", [[(112, 91), (114, 129)], [
        (232, 180), (233, 133)], [(234, 132), (235, 90)]]),
    ("1NYI.cg", [[(104, 23), (109, 118)]]),
    ("1QRS.cg", [[(25, 10), (27, 43)], [(65, 49), (66, 7)]]),
    ("1S72.cg", [[(21, 522), (28, 480)], [(29, 479), (32, 451)], [(52, 109), (53, 66)], [(149, 42), (154, 182)],
                 [(239, 431), (244, 267)], [(344, 332),
                                            (349, 302)], [(774, 887), (780, 866)],
                 [(823, 791), (828, 853)], [(928, 915), (931, 1039)], [
        (1205, 1194), (1208, 1159)],
        [(1267, 1089), (1268, 1290)], [(1300, 905),
                                       (1305, 1349)], [(1412, 1697), (1415, 1680)],
        [(1551, 1634), (1552, 1569)], [(1715, 1703),
                                       (1718, 1404)], [(2115, 2470), (2118, 2276)],
        [(2241, 2134), (2245, 2256)], [(2552, 2602), (2555, 2580)], [(2831, 2909), (2832, 2848)]]),
    ("1U0B.cg", [[(25, 10), (27, 43)], [(65, 49), (66, 7)]]),
    ("1U6B.cg", [[(9, 1), (13, 37)], [
        (93, 51), (94, 124)], [(143, 41), (144, 166)]]),
    ("1U8D.cg", [[(21, 75), (27, 43)]]),
    ("1U9S.cg", [[(94, 80), (96, 107)], [(119, 222), (132, 168)],
                 [(194, 176), (196, 217)], [(230, 110), (231, 79)]]),
    ("1UN6.cg", [[(65, 14), (66, 109)]]),
    ("1X8W.cg", [[(138, 180), (141, 162)]]),
    ("1Y0Q.cg", [[(138, 127), (142, 155)]]),
    ("1Y26.cg", [[(72, 54), (75, 21)]]),
    ("2A2E.cg", [[(87, 73), (88, 101)], [
        (169, 151), (172, 189)], [(202, 102), (204, 71)]]),
    ...
    ("2AVY.cg", [[(764, 577), (769, 810)], [(879, 821), (881, 569)], [(19, 916), (27, 556)],
                 [(106, 61), (113, 314)], [(176, 146),
                                           (184, 193)], [(219, 198), (221, 142)],
                 [(311, 289), (312, 115)], [(337, 316),
                                            (339, 350)], [(392, 369), (395, 46)],
                 [(651, 588), (655, 751)], [(672, 734),
                                            (677, 713)], [(857, 829), (861, 868)],
                 [(1034, 1027), (1037, 1003)], [(1044, 997),
                                                (1047, 1210)], [(1073, 1102), (1074, 1083)],
                 [(1116, 1184), (1118, 1155)]]),
    ("2AW4.cg", [[(25, 515), (31, 474)], [(32, 473), (35, 445)], [(130, 121), (131, 148)], [(179, 46), (184, 212)],
                 [(683, 794), (689, 773)], [(732, 700),
                                            (736, 760)], [(835, 822), (838, 940)],
                 [(1101, 1090), (1104, 1055)], [(1163, 991),
                                                (1164, 1185)], [(1261, 579), (1269, 2011)],
                 [(1294, 1276), (1295, 1645)], [(1306, 1622),
                                                (1309, 1605)], [(1444, 1547), (1445, 1466)],
                 [(1525, 1467), (1529, 1542)], [(1639, 1627),
                                                (1642, 1298)], [(1988, 1764), (1994, 1666)],
                 [(2009, 1648), (2010, 1270)], [(2074, 2435),
                                                (2077, 2243)], [(2196, 2093), (2200, 2223)],
                 [(2370, 2347), (2372, 2381)], [(2446, 2064),
                                                (2455, 2500)], [(2517, 2567), (2520, 2545)],
                 [(2805, 2791), (2811, 2889)], [(2812, 2888), (2815, 2831)]]),
    ("3F4E.cg", [[(27, 15), (31, 84)], [(46, 33), (50, 59)]]),
    ("2J00.cg", [[(19, 916), (27, 556)], [(106, 61), (113, 314)], [(311, 289), (312, 115)], [(337, 316), (339, 350)], [(392, 369), (395, 46)], [(651, 588), (655, 751)], [
     (672, 734), (677, 713)], [(857, 829), (861, 868)], [(1033, 1029), (1040, 1001)], [(1044, 997), (1047, 1210)], [(1073, 1102), (1074, 1083)], [(1116, 1184), (1118, 1155)]]),
    ("2J01.cg", [[(24, 516), (31, 474)], [(32, 473), (35, 445)], [(56, 114), (57, 70)], [(179, 45), (184, 212)], [(337, 325), (341, 297)], [(683, 794), (689, 773)], [(732, 700), (736, 760)], [(835, 822), (836, 943)], [(1195, 812), (1198, 1247)], [(1261, 589), (1269, 2011)], [(1267, 991), (1268, 1290)], [(1294, 1276), (1295, 1645)], [(1306, 1622), (1309, 1605)], [(1402, 1385), (1405, 1597)], [(1444, 1547), (1445, 1466)], [
     (1639, 1627), (1642, 1298)], [(1788, 1776), (1792, 1827)], [(1975, 1830), (1979, 1772)], [(1988, 1764), (1994, 1666)], [(2009, 1648), (2010, 1270)], [(2074, 2435), (2077, 2243)], [(2196, 2093), (2200, 2223)], [(2370, 2347), (2372, 2381)], [(2446, 2064), (2455, 2496)], [(2517, 2567), (2520, 2545)], [(2580, 2508), (2588, 2606)], [(2674, 2646), (2676, 2731)], [(2769, 2735), (2771, 2643)], [(2814, 2886), (2815, 2831)]]),
    ("2BTE.cg", [[(65, 49), (66, 7)]]),
    #("2B57.cg", [[(72,54),(75,21)] ]),
    ("2CKY.cg", [[(5, 75), (7, 39)]]),
    ("2CZJ.cg", [[(65, 49), (68, 5)]]),
    ...
    ("3E5C.cg", [[(35, 9), (40, 47)]]),
    ("3EOH.cg", [[(40, 28), (43, 65)]]),
    ("3F2Q.cg", [[(27, 15), (31, 84)], [(46, 33), (49, 60)],
                 [(80, 64), (83, 32)], [(97, 86), (105, 8)]]),
...
def bulge_from_seqids(cg, bp1, bp2, asserts=True):
    try:
        ...
        if asserts:
            assert cg.pairing_partner(cg.seq_id_to_pos(
                bp1[0])) == cg.seq_id_to_pos(bp1[1])
        if asserts:
            assert len(stem1) == 1
        stem1, = stem1
        ...
        for method in 'CG', 'Tyagi':
            ...
            for pdb, stacks in data:
                cg = ftmc.CoarseGrainRNA(
                    "test/forgi/threedee/data/stacking/" + pdb)
                for stack in stacks:
                    try:
                        ...
                        try:
                            print(pdb, stack[0], stack[1],
                                  cg.pairing_partner(
                                      cg.seq_id_to_pos(stack[0][0])),
                                  cg.pairing_partner(
                                      cg.seq_id_to_pos(stack[0][1])),
                                  cg.pairing_partner(
                                      cg.seq_id_to_pos(stack[1][0])),
            ...
            print("Out of {:4}, {:4} were found, {:4} not found, {:4} different sec structure".format(
                all_true, true_found, true_not_found, true_different_ss))
            print("Out of {:4}, {:4.2f}% were found, {:4.2f}% not found, {:4.2f}% different sec structure".format(
                all_true, true_found / all_true * 100, true_not_found / all_true * 100, true_different_ss / all_true * 100))
